...
} from 'src/helpers/serializations/response.paging.serialization';
import {
...
import { IResponsePaging } from 'src/helpers/interfaces/response.interface';
            ...
            return next.handle().pipe(
                map(async (res: Promise<IResponsePaging>) => {
                    ...
                    const message: string | IMessage =
                        await this.helperService.get(messagePath, {
